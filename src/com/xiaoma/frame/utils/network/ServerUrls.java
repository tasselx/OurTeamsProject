...
/**
 * @TODO [The ServerUrl Class]
 * @author XiaoMaGuo ^_^
 * @version [version-code, 2013-9-26]
...
public class ServerUrls implements Serializable
{
    ...
    public final static String URL_TYPE_NEWS = URL_WWW_HOST + URL_SPLITTER + "news" + URL_SPLITTER;
    ...
    public static final String myTestUrl =
        "http://b.hiphotos.baidu.com/album/w%3D2048/sign=7cc100c321a446237ecaa262ac1a700e/e850352ac65c103842a0b47bb3119313b17e89a8.jpg";
     ...
     */
    public final static ServerUrls parseURL(String path)
    {
        if (StringUtils.isEmpty(path))
            return null;
        path = formatURL(path);
        ServerUrls urls = null;
        String objId = "";
        try
        {
