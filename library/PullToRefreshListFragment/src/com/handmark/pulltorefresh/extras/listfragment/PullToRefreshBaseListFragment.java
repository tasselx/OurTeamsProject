...
abstract class PullToRefreshBaseListFragment<T extends PullToRefreshBase<? extends AbsListView>> extends ListFragment
{
    ...
    /**
     * Returns the {@link PullToRefreshBase} which will replace the ListView created from ListFragment. You should
     * override this method if you wish to customise the {@link PullToRefreshBase} from the default.
     * 
     * @param inflater - LayoutInflater which can be used to inflate from XML.
     * @param savedInstanceState - Bundle passed through from
     *            {@link ListFragment#onCreateView(LayoutInflater, ViewGroup, Bundle) onCreateView(...)}
