...
public abstract class MenuDrawer extends ViewGroup
{
     ...
     * event. This lets the listener decide if the pointer is on a view that would disallow dragging of the drawer. This
     * is only called when the touch mode is {@link #TOUCH_MODE_FULLSCREEN}.
     */
     ...
     * @param dragMode The drag mode of the drawer. Can be either {@link MenuDrawer#MENU_DRAG_CONTENT} or
    ...
    private static void attachToContent(Activity activity, MenuDrawer menuDrawer)
    {
         ...
         * overridden and dispatched to MenuDrawer#setContentView, which then again would call Activity#setContentView.
         */
    ...
    protected void initDrawer(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        TypedArray a =
            context.obtainStyledAttributes(attrs,
                R.styleable.MenuDrawer,
                R.attr.menuDrawerStyle,
        ...
        mDropShadowSize =
            a.getDimensionPixelSize(R.styleable.MenuDrawer_mdDropShadowSize, dpToPx(DEFAULT_DROP_SHADOW_DP));
        
        mTouchBezelSize =
            a.getDimensionPixelSize(R.styleable.MenuDrawer_mdTouchBezelSize, dpToPx(DEFAULT_DRAG_BEZEL_DP));
    ...
    /**
     * Set the active view. If the mdActiveIndicator attribute is set, this View will have the indicator drawn next to
     * it.
     * 
     ...
     * 
     * @param v The active view.
     * @param position Optional position, usually used with ListView. v.setTag(R.id.mdActiveViewPosition, position) must
     *            be called first.
     */
